...
class lab_comu_1(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self._frequency_range = qtgui.Range(-samp_rate/2, samp_rate/2, 100, 4500, 200)
        self._frequency_win = qtgui.RangeWidget(self._frequency_range, self.set_frequency, "'frequency'", "counter", float, QtCore.Qt.Horizontal)
