...
class Prueba00(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self._t_band_win = qtgui.RangeWidget(self._t_band_range, self.set_t_band, "Banda de transmicion", "counter_slider", float, QtCore.Qt.Horizontal)
        ...
        self._A_range = qtgui.Range(0, 5e-1, 1e-2, 5e-1, 200)
        ...
        self.filter_fft_low_pass_filter_0 = filter.fft_filter_fff(1, firdes.low_pass(1, samp_rate, fcut, t_band, window.WIN_HAMMING, 6.76), 1)
        ...
        self.connect((self.blocks_add_xx_0, 0), (self.filter_fft_low_pass_filter_0, 0))
        ...
        self.connect((self.filter_fft_low_pass_filter_0, 0), (self.qtgui_time_sink_x_0, 0))
    ...
    def set_samp_rate(self, samp_rate):
        ...
        self.filter_fft_low_pass_filter_0.set_taps(firdes.low_pass(1, self.samp_rate, self.fcut, self.t_band, window.WIN_HAMMING, 6.76))
